...
import Interview from '../models/inter_model.js'
        ...
        const messages = [
            {
                ...
                Return ONLY valid JSON. Do not include backticks, markdown, or any extra text:
...
export const submitAnswer = async (req, res) => {
    try {
        const { interviewId, questionIndex, timeTaken } = req.body;
        ...
        const messages = [
            {
                ...
                Calculate:
                finalScore=average of confidence,communication,and correctness(rounded to nearest whole numbers).
                
                Feedback Rules:
                -Write natural humman feedback.
                -10 to 15 words only.
...
export const finishInterview=async(req,res)=>{
    try{
        ...
        const interview =await Interview.findById(interviewId)
        if(!interview){
            return res.status(400).json({meesage:"failed to find Interview"})
