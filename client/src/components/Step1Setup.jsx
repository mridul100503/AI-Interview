...
import {
  FaUserTie, FaFileUpload, FaMicrophoneAlt, FaChartLine,
  FaBriefcase
} from "react-icons/fa";
        ...
        >
          ...
          <div className='space-y-6'>
            <div className='relative '>
              ...
              <input type="text" placeholder='Enter role' className='w-full p-12 pr-4 py-3 border-gray-200
              rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'onChange={(e) => setRole(e.target.value)} value={role} />
            </div>
            <div className='relative '>
              <FaBriefcase className='absolute top-4 left-4 text-gray-400' />
              <input type="text" placeholder='Enter experience' className='w-full p-12 pr-4 py-3 border-gray-200
              rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'onChange={(e) => setExperience(e.target.value)} value={experience} />
            ...
            {analysisDone && (
              <motion.div
                ...
                className='bg-gray-30 border border-gray-200 rounded-xl p-5 space-y-4'
              >
                ...
                {skills.length > 0 && (
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      {skills.map((s, i) => (
                        <span key={i} className='bg-green-100 text-green-700 px-3 py-1rounded-full text-sm'>{s}</span>
                      ))}
                    </div>
