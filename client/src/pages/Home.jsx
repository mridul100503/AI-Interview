        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [{
                ...
                desc: "Real-time pressure with time track"
              }].map((item, index) => (
                <motion.div
                  key={index}
                  ...
                  whileHover={{ rotate: 0, scale: 1.06 }} className={`relative bg-white rounded-3xl border-2 border-green-100
                  hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all
                  duration-300
                  ${index === 0 ? "rotate-[-4deg]" : ""}
                  ${index === 1 ? "rotate-[-3deg] md:-mt-6 shadow-xl" : ""}
                  ${index === 2 ? "rotate-[3deg]" : ""}
                  `}>
                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-green text-green-600 w-16 h-16 
                  ...
                  <div className='pt-10 text-center'>
                    ...
                    <p className='text-sm text-gray-500 leding-relaxed'>{item.desc}</p>
                  </div>
          ...
          <div className='mb-32'>
            <motion.h2
              ...
              Advanced AI{" "}
              <span className="text-green-600">Capabalities</span>
            </motion.h2>
                ...
                [
                  ...
                  <motion.div key={index}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      <div className='w-full md:w-1/2 flex justidy-center'>
