  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-10'>
      <div className='w-[90vw] lg:w-[70vw]max-w-[90%] mx-auto'>
        ...
        className='bg-white p-10 rounded-2xl shadow text-center'>
            ...
            className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border border-gray-100">
              <div className='flex flex-col md:flex-row md:item-center md:justify-between gap-4'>
                <div>
                  ...
                  <p className='txt-gray-500 text-sm mt-1'>{item.experience} . {item.mode}</p>
                ...
                <div className='flex items-center gap-6'>
                  ...
                  <span className={`px-4 py-1 rounded-full text-sx font-medium ${item.status ==="completed"?"bg-emerald-100 text-emerald-700":"bg-yellow-100 text-yellow-700"}`}>
                    {item.status}
                  </span>
