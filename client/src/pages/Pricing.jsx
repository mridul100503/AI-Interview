...
function Pricing() {
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-emerald-50 py-16 px-10'>
      ...
      <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto'>
        {plans.map((plan) => {
          ...
          return (
            <motion.div
              key={plan.id}
              whileHover={plan.default ? undefined : { scale: 1.03 }}
            ...
            >
              ...
              {!plan.default &&
                <button disabled={loadingPlan===plan.id}onClick={(e)=>{e.stopPropagation();
                  ...
                  {loadingPlan===plan.id?"Processing...":isSelected?"Process to Pay":"Select Plan"}
                </button>
